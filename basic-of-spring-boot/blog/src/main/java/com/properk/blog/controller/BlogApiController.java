...
public class BlogApiController {
    ...
    public ResponseEntity<Article> addArticle(@RequestBody AddArticleRequest article, Principal principal) {
        Article savedArticle = blogService.save(article, principal.getName());
